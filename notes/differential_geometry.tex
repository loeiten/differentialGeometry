...
\footnotetext{An isomorphism is a homomorphism\footnotemark that admits an 
	      inverse.}%
\footnotetext{A homomorphism (or more generally a morphism\footnotemark)
              is a structure-preserving map between two
...
\begin{example}{Vector field transformation by transforming the basis vectors}
 ...
 \begin{align*}
     ...
     =& A_x (-\rho \sin\phi \grad \phi + \cos\phi \grad \rho)
      ...
      + A_z (\grad z)\\
     =&  ( A_x\cos\phi + A_y\sin\phi \grad \rho)\grad \rho
